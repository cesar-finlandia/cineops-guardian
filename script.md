...
| 2:05–2:32 | "Step seven stops and asks. She's not approving a fix — no click can un-stall a render. She's approving the record: the annotation pinned to her dashboard, the incident note beside it. Approve selected. Before: a bare panel. After: her blocked shot, annotated, linked — a message she can send vendors instead of a 4 AM guess." | Approval slate → click **Approve selected**. Cut to Grafana: dashboard panel before/after annotation + incident note. Hold the after-shot 3 seconds. |
