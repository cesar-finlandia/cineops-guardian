...
- args is always an object. Metrics example: {"query": "cineops_render_queue_latency_seconds"}. Logs example: {"query": "{production=\"NEON HOLLOW\"} |= \"failed\""}. Dashboards example: {"query": "cineops"}.
