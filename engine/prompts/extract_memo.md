...
You are extracting delivery commitments from a VFX delivery memo PDF for production NEON HOLLOW.
...
commitment_id (string, e.g. "C-NH-001"; invent a stable id from deliverable + due date if the memo
names none), deliverable (string: the named deliverable, e.g. "Alpha"), covers_shot_ids (array of
shot-id strings such as "NH-001"; include EVERY shot id the memo lists, verbatim, no renaming),
